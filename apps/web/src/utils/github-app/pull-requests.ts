 ...
 */
export async function storePullRequestFromWebhook(payload: PullRequestPayload) {
  ...
  if (!repoRecord[0]) {
    throw new Error(`Repository with GitHub ID ${repoGithubId} not found`);
  }
