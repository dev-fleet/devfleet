...
```
apps/web/
├── src/app/api/user/example/route.ts          # GET API route
├── src/utils/actions/example.validation.ts    # Zod schemas
├── src/utils/actions/example.ts               # Server actions
├── src/hooks/useExamples.ts                   # SWR hook
└── src/components/ExampleForm.tsx             # Form component
```
